...
class encoder2(nn.Module):
    ...
    def forward(self,x,sF=None,contentV256=None,styleV256=None,matrix11=None):
        output = {}
        out = self.conv1(x)
        out = self.reflecPad1(out)
        out = self.conv2(out)
        ...
        if(matrix11 is not None):
            feature = matrix11(output['r11'],sF['r11'],contentV256,styleV256)
            out = self.reflecPad3(feature)
        else:
            out = self.reflecPad3(output['r11'])

        out = self.conv3(out)
        output['r12'] = self.relu3(out)
        out,output['pool_idx'] = self.maxPool(output['r12'])
...
class encoder3(nn.Module):
    ...
    def forward(self,x,sF=None,contentV256=None,styleV256=None,matrix11=None,matrix21=None):
        output = {}
        out = self.conv1(x)
        out = self.reflecPad1(out)
        out = self.conv2(out)
        ...
        if(matrix21 is not None):
            feature = matrix21(output['r21'],sF['r21'],contentV256,styleV256)
            out = self.reflecPad5(feature)
        else:
            out = self.reflecPad5(output['r21'])

        out = self.conv5(out)
        output['r22'] = self.relu5(out)
        out,output['pool_idx2'] = self.maxPool2(output['r22'])
        out = self.reflecPad6(out)
        out = self.conv6(out)
...
class encoder4(nn.Module):
    ...
    def forward(self,x,sF=None,contentV256=None,styleV256=None,matrix11=None,matrix21=None,matrix31=None):
        ...
        out,output['pool_idx3'] = self.maxPool3(output['r34'])
        out = self.reflecPad10(out)
        out = self.conv10(out)
        output['r41'] = self.relu10(out)
        #return output['r41'],output['pool_idx'],output['r12'].size(),output['pool_idx2'],output['r22'].size(),output['pool_idx3'],output['r34'].size()
        return output
...
class encoder5(nn.Module):
    ...
    def forward(self,x):
        ...
        out = self.conv3(out)
        output['r12'] = self.relu3(out)
        output['p1'],output['pool_idx'] = self.maxPool(output['r12'])
        ...
        out = self.conv5(out)
        output['r22'] = self.relu5(out)
        output['p2'],output['pool_idx2'] = self.maxPool2(output['r22'])
        ...
        out = self.conv9(out)
        output['r34'] = self.relu9(out)
        output['p3'],output['pool_idx3'] = self.maxPool3(output['r34'])
        ...
        output['p4'],output['pool_idx4'] = self.maxPool4(output['r44'])
...
class decoder5(nn.Module):
    ...
    def forward(self,x,pool_idx,pool1,pool_idx2,pool2,pool_idx3,pool3,pool_idx4,pool4):
        # decoder
        out = self.reflecPad15(x)
        out = self.conv15(out)
        out = self.relu15(out)
        out = self.unpool(out,pool_idx4,output_size=pool4)
        out = self.reflecPad16(out)
        out = self.conv16(out)
        out = self.relu16(out)
        out = self.reflecPad17(out)
        ...
        out = self.conv19(out)
        out = self.relu19(out)
        out = self.unpool2(out,pool_idx3,output_size=pool3)
        ...
        out = self.conv23(out)
        out = self.relu23(out)
        out = self.unpool3(out,pool_idx2,output_size=pool2)
        ...
        out = self.conv25(out)
        out = self.relu25(out)
        out = self.unpool4(out,pool_idx,output_size=pool1)
