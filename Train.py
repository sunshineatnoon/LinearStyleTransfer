...
parser.add_argument("--loss_network_dir", default='/home/xtli/WEIGHTS/WCT_Pytorch/vgg_normalised_conv5_1.t7', help='used for loss network')
...
parser.add_argument("--style_weight", type=float, default=0.05, help='style loss weight')
